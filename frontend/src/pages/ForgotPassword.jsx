...
export default function ForgotPassword() {
  ...
  async function requestCode() {
    ...
    } catch (error) { setRecoveryEmailMissing(error.data?.code === 'CONTACT_EMAIL_REQUIRED'); if (error.data?.retryAfterSeconds) cooldown.start(error.data.retryAfterSeconds); toast.error(error.message) } finally { setLoading(false) }
  }
